...
const containsAnd = (arr) => {
  ...
  let containsAndArray = arr.filter(function(string,i){
...
const oddValues = (arr) => {
  ...
  let oddValuesArray = arr.filter(function(n,i){
    return !(n%2 == 0);
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  let compareNum = minBaseStat;
  let statArray = arr.filter(function(value, idx){
    return (compareNum<value.baseStat);
  }); return statArray;
};
