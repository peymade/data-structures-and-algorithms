...
const raisedToTheThird = (arr) => {
  let raisedToTheThirdArray = arr.map(function(value,idx){
    return Math.pow(value, 3);
  }); 
  return raisedToTheThirdArray;
}
...
const addOne = (arr) => {
  let addOneArray = arr.map(function(value, idx){
    return value + 1;
  }); return addOneArray;
};
...
const addQuestion = (arr) => {
  let addQuestionArray = arr.map(function(word, idx){
    return word + '?';
  }); return addQuestionArray;
};
...
const forEachTwoToThe = (arr) => {
  ...
  arr.forEach(function(value){
    forEachArray.push(Math.pow(2,value))
  }); return forEachArray;
};
...
const mapTwoToThe = (arr) => {
  let mapTwoToTheArray = arr.map(function(value, idx){
    return Math.pow(2, value);
  }); return mapTwoToTheArray;
};
...
const charCode = (arr) => {
  let charArray = arr.map(function(value, idx){
...
let evenOdd = (arr) => {
  let evenOddArray = arr.map(function(value, idx){
    if(value % 2 == 0) {
      return 'even';
    } else if (value % 2 == 1){
      return 'odd';
...
const extractAbilities = (arr) => {
  let newExtractArray = arr.map(function(value, idx){
   return value.ability.name;
  }); return newExtractArray;
}
/* ------------------------------------------------------------------------------------------------
